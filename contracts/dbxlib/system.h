...
extern "C" {
    ...
    */
   void  dbx_assert( uint32_t test, const char* msg );
    ...
    */
   void  dbx_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  dbx_assert_code( uint32_t test, uint64_t code );
    ...
    */
   [[noreturn]] void  dbx_exit( int32_t code );
