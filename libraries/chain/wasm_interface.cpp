...
class softfloat_api : public context_aware_api
{
  public:
    ...
    float _dbx_f32_max(float af, float bf)
    {
        float32_t a = to_softfloat32(af);
        float32_t b = to_softfloat32(bf);
        if (is_nan(a)) {
      ...
      float _dbx_f32_copysign(float af, float bf)
      {
          float32_t a = to_softfloat32(af);
          float32_t b = to_softfloat32(bf);
      ...
      // float unops
      float _dbx_f32_abs(float af)
      {
          float32_t a = to_softfloat32(af);
          a.v &= ~(1 << 31);
          return from_softfloat32(a);
      }
      float _dbx_f32_neg(float af)
      {
          float32_t a = to_softfloat32(af);
      ...
      float _dbx_f32_nearest(float af)
      {
          float32_t a = to_softfloat32(af);
          int e = a.v >> 23 & 0xff;
          int s = a.v >> 31;
      ...
      // float relops
      bool _dbx_f32_eq(float a, float b) { return f32_eq(to_softfloat32(a), to_softfloat32(b)); }
      bool _dbx_f32_ne(float a, float b) { return !f32_eq(to_softfloat32(a), to_softfloat32(b)); }
      bool _dbx_f32_lt(float a, float b) { return f32_lt(to_softfloat32(a), to_softfloat32(b)); }
      bool _dbx_f32_le(float a, float b) { return f32_le(to_softfloat32(a), to_softfloat32(b)); }
      bool _dbx_f32_gt(float af, float bf)
      {
          float32_t a = to_softfloat32(af);
          float32_t b = to_softfloat32(bf);
          if (is_nan(a))
      ...
      bool _dbx_f32_ge(float af, float bf)
      {
          float32_t a = to_softfloat32(af);
          float32_t b = to_softfloat32(bf);
          if (is_nan(a))
      ...
      double _dbx_f64_max(double af, double bf)
      {
          float64_t a = to_softfloat64(af);
          float64_t b = to_softfloat64(bf);
          if (is_nan(a))
      ...
      double _dbx_f64_copysign(double af, double bf)
      {
          float64_t a = to_softfloat64(af);
          float64_t b = to_softfloat64(bf);
      ...
      // double unops
      double _dbx_f64_abs(double af)
      {
          float64_t a = to_softfloat64(af);
          a.v &= ~(uint64_t(1) << 63);
          return from_softfloat64(a);
      }
      double _dbx_f64_neg(double af)
      {
          float64_t a = to_softfloat64(af);
      ...
      double _dbx_f64_sqrt(double a)
      {
          float64_t ret = f64_sqrt(to_softfloat64(a));
          return from_softfloat64(ret);
      }
      // ceil, floor, trunc and nearest are lifted from libc
      double _dbx_f64_ceil(double af)
      {
          float64_t a = to_softfloat64(af);
          float64_t ret;
          int e = a.v >> 52 & 0x7ff;
      ...
      double _dbx_f64_floor(double af)
      {
          float64_t a = to_softfloat64(af);
          float64_t ret;
          int e = a.v >> 52 & 0x7FF;
      ...
      double _dbx_f64_trunc(double af)
      {
          float64_t a = to_softfloat64(af);
      ...
      double _dbx_f64_nearest(double af)
      {
          float64_t a = to_softfloat64(af);
          int e = (a.v >> 52 & 0x7FF);
          int s = a.v >> 63;
      ...
      // double relops
      bool _dbx_f64_eq( double a, double b ) { return f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
      bool _dbx_f64_ne(double a, double b) { return !f64_eq(to_softfloat64(a), to_softfloat64(b)); }
      bool _dbx_f64_lt(double a, double b) { return f64_lt(to_softfloat64(a), to_softfloat64(b)); }
      bool _dbx_f64_le(double a, double b) { return f64_le(to_softfloat64(a), to_softfloat64(b)); }
      bool _dbx_f64_gt(double af, double bf)
      {
          float64_t a = to_softfloat64(af);
          float64_t b = to_softfloat64(bf);
          if (is_nan(a))
      ...
      bool _dbx_f64_ge(double af, double bf)
      {
          float64_t a = to_softfloat64(af);
          float64_t b = to_softfloat64(bf);
          if (is_nan(a))
      ...
      double _dbx_f32_promote(float a)
      {
          return from_softfloat64(f32_to_f64(to_softfloat32(a)));
      }
      float _dbx_f64_demote(double a)
      {
          return from_softfloat32(f64_to_f32(to_softfloat64(a)));
      }
      int32_t _dbx_f32_trunc_i32s(float af)
      {
          float32_t a = to_softfloat32(af);
          if (_dbx_f32_ge(af, 2147483648.0f) || _dbx_f32_lt(af, -2147483648.0f))
          ...
          return f32_to_i32(to_softfloat32(_dbx_f32_trunc(af)), 0, false);
      }
      int32_t _dbx_f64_trunc_i32s(double af)
      {
          float64_t a = to_softfloat64(af);
          if (_dbx_f64_ge(af, 2147483648.0) || _dbx_f64_lt(af, -2147483648.0))
          ...
          return f64_to_i32(to_softfloat64(_dbx_f64_trunc(af)), 0, false);
      }
      uint32_t _dbx_f32_trunc_i32u(float af)
      {
          float32_t a = to_softfloat32(af);
          if (_dbx_f32_ge(af, 4294967296.0f) || _dbx_f32_le(af, -1.0f))
          ...
          return f32_to_ui32(to_softfloat32(_dbx_f32_trunc(af)), 0, false);
      }
      uint32_t _dbx_f64_trunc_i32u(double af)
      {
          float64_t a = to_softfloat64(af);
          if (_dbx_f64_ge(af, 4294967296.0) || _dbx_f64_le(af, -1.0))
          ...
          return f64_to_ui32(to_softfloat64(_dbx_f64_trunc(af)), 0, false);
      }
      int64_t _dbx_f32_trunc_i64s(float af)
      {
          float32_t a = to_softfloat32(af);
          if (_dbx_f32_ge(af, 9223372036854775808.0f) || _dbx_f32_lt(af, -9223372036854775808.0f))
          ...
          return f32_to_i64(to_softfloat32(_dbx_f32_trunc(af)), 0, false);
      }
      int64_t _dbx_f64_trunc_i64s(double af)
      {
          float64_t a = to_softfloat64(af);
          if (_dbx_f64_ge(af, 9223372036854775808.0) || _dbx_f64_lt(af, -9223372036854775808.0))
          ...
          return f64_to_i64(to_softfloat64(_dbx_f64_trunc(af)), 0, false);
      }
      uint64_t _dbx_f32_trunc_i64u(float af)
      {
          float32_t a = to_softfloat32(af);
          if (_dbx_f32_ge(af, 18446744073709551616.0f) || _dbx_f32_le(af, -1.0f))
          ...
          return f32_to_ui64(to_softfloat32(_dbx_f32_trunc(af)), 0, false);
      }
      uint64_t _dbx_f64_trunc_i64u(double af)
      {
          float64_t a = to_softfloat64(af);
          if (_dbx_f64_ge(af, 18446744073709551616.0) || _dbx_f64_le(af, -1.0))
          ...
          return f64_to_ui64(to_softfloat64(_dbx_f64_trunc(af)), 0, false);
      }
      float _dbx_i32_to_f32(int32_t a)
      {
          return from_softfloat32(i32_to_f32(a));
      }
      float _dbx_i64_to_f32(int64_t a)
      {
          return from_softfloat32(i64_to_f32(a));
      }
      float _dbx_ui32_to_f32(uint32_t a)
      {
          return from_softfloat32(ui32_to_f32(a));
      }
      float _dbx_ui64_to_f32(uint64_t a)
      {
          return from_softfloat32(ui64_to_f32(a));
      }
      double _dbx_i32_to_f64(int32_t a)
      {
          return from_softfloat64(i32_to_f64(a));
      }
      double _dbx_i64_to_f64(int64_t a)
      {
          return from_softfloat64(i64_to_f64(a));
      }
      double _dbx_ui32_to_f64(uint32_t a)
      {
          return from_softfloat64(ui32_to_f64(a));
      }
      double _dbx_ui64_to_f64(uint64_t a)
      {
...
REGISTER_INJECTED_INTRINSICS(softfloat_api,
      (_dbx_f32_add,       float(float, float)    )
      (_dbx_f32_sub,       float(float, float)    )
      (_dbx_f32_mul,       float(float, float)    )
      (_dbx_f32_div,       float(float, float)    )
      (_dbx_f32_min,       float(float, float)    )
      (_dbx_f32_max,       float(float, float)    )
      (_dbx_f32_copysign,  float(float, float)    )
      (_dbx_f32_abs,       float(float)           )
      (_dbx_f32_neg,       float(float)           )
      (_dbx_f32_sqrt,      float(float)           )
      (_dbx_f32_ceil,      float(float)           )
      (_dbx_f32_floor,     float(float)           )
      (_dbx_f32_trunc,     float(float)           )
      (_dbx_f32_nearest,   float(float)           )
      (_dbx_f32_eq,        int(float, float)      )
      (_dbx_f32_ne,        int(float, float)      )
      (_dbx_f32_lt,        int(float, float)      )
      (_dbx_f32_le,        int(float, float)      )
      (_dbx_f32_gt,        int(float, float)      )
      (_dbx_f32_ge,        int(float, float)      )
      (_dbx_f64_add,       double(double, double) )
      (_dbx_f64_sub,       double(double, double) )
      (_dbx_f64_mul,       double(double, double) )
      (_dbx_f64_div,       double(double, double) )
      (_dbx_f64_min,       double(double, double) )
      (_dbx_f64_max,       double(double, double) )
      (_dbx_f64_copysign,  double(double, double) )
      (_dbx_f64_abs,       double(double)         )
      (_dbx_f64_neg,       double(double)         )
      (_dbx_f64_sqrt,      double(double)         )
      (_dbx_f64_ceil,      double(double)         )
      (_dbx_f64_floor,     double(double)         )
      (_dbx_f64_trunc,     double(double)         )
      (_dbx_f64_nearest,   double(double)         )
      (_dbx_f64_eq,        int(double, double)    )
      (_dbx_f64_ne,        int(double, double)    )
      (_dbx_f64_lt,        int(double, double)    )
      (_dbx_f64_le,        int(double, double)    )
      (_dbx_f64_gt,        int(double, double)    )
      (_dbx_f64_ge,        int(double, double)    )
      (_dbx_f32_promote,    double(float)         )
      (_dbx_f64_demote,     float(double)         )
      (_dbx_f32_trunc_i32s, int(float)            )
      (_dbx_f64_trunc_i32s, int(double)           )
      (_dbx_f32_trunc_i32u, int(float)            )
      (_dbx_f64_trunc_i32u, int(double)           )
      (_dbx_f32_trunc_i64s, int64_t(float)        )
      (_dbx_f64_trunc_i64s, int64_t(double)       )
      (_dbx_f32_trunc_i64u, int64_t(float)        )
      (_dbx_f64_trunc_i64u, int64_t(double)       )
      (_dbx_i32_to_f32,     float(int32_t)        )
      (_dbx_i64_to_f32,     float(int64_t)        )
      (_dbx_ui32_to_f32,    float(int32_t)        )
      (_dbx_ui64_to_f32,    float(int64_t)        )
      (_dbx_i32_to_f64,     double(int32_t)       )
      (_dbx_i64_to_f64,     double(int64_t)       )
      (_dbx_ui32_to_f64,    double(int32_t)       )
      (_dbx_ui64_to_f64,    double(int64_t)       )
);
