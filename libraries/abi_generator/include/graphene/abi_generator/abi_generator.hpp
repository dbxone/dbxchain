...
namespace graphene {
   ...
   struct find_dbx_abi_macro_action : public PreprocessOnlyAction {

         string& contract;
         vector<string>& actions;
         const string& abi_context;

         find_dbx_abi_macro_action(string& contract, vector<string>& actions, const string& abi_context
            ): contract(contract),
         ...
         struct callback_handler : public PPCallbacks {
            ...
            CompilerInstance& compiler_instance;
            find_dbx_abi_macro_action& act;

            callback_handler(CompilerInstance& compiler_instance, find_dbx_abi_macro_action& act)
